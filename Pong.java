...
public class Pong extends JFrame implements MouseListener, KeyListener, Runnable, MouseMotionListener
{
    ...
    public void paintComponent(Graphics g)
    {
        ...
        else
        {
            ...
            //For some reason this can't be included in the first if statement, like points2 condition
            if(ball.x>1575)
            {
                points1++;
            }
    ...
    //threads, this makes the movements in the game much more smooth, and allows more than key to be pressed and registered at the same time
    public void run()
    {
        try
            {
    ...
    // this will update the position of the paddle and the ball in the game.
    public void move()
    {
        p1.y = p1.y + p1inc;
        //p2.y = p2.y + p2inc; if you decide to change the controls and don't want to use the mouse to control the left paddle then un-comment the is line of code. 
    ...
    // if you change the controls, and don't want to use the mouse for the movevment of the left paddle, then erase the code in the following function.
    @Override
